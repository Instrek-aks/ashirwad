    ...
    <div className="op-page-wrapper">
      ...
      >
        ...
        >
          ...
          <h1 className="op-hero-title" style={{ margin: 0, lineHeight: 1.15 }}>Measuring Caps<br />&amp; Oral Droppers</h1>
        </div>
      </section>
      ...
      <section className="op-gallery-section" ref={galleryRef}>
        <div className="container">
          <div className={`fade-section ${galleryVisible ? 'visible' : ''}`}>
            ...
            <h2 className="op-gallery-title">Measuring Caps &amp; Droppers Gallery</h2>
