...
export default function MeasuringProductPage({ onNavigate }) {
  ...
  const carouselImages = [
    "/Measuring Caps & Oral Droppers.webp"
  ]
  ...
  return (
    <div className="op-page-wrapper">
      ...
      <section 
        className="op-hero"
        style={{
          backgroundImage: "linear-gradient(180deg, rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.55)), url('/Measuring Caps & Oral Droppers.webp')",
          position: 'relative',
          minHeight: '280px',
          height: 'auto',
          display: 'flex',
        ...
        <div className="container">
          ...
          >
            <nav className="op-breadcrumb" style={{ margin: 0 }}>
              ...
              <span className="breadcrumb-separator">&gt;</span>
              <span className="breadcrumb-active">MEASURING CAPS &amp; ORAL DROPPERS</span>
            </nav>
            <h1 className="op-hero-title" style={{ margin: 0, lineHeight: 1.15 }}>Measuring Caps &amp; Oral Droppers</h1>
          </div>
        </div>
      </section>
      ...
      <div className="op-tabs-bar" ref={tabsRef}>
        <div className="container op-tabs-container">
          {productsList.map((prod, idx) => (
            <button 
              key={idx}
              className={`op-tab-btn ${prod.path === 'product-measuring' ? 'active' : ''}`} 
      ...
      <section className="op-overview-section" ref={overviewRef}>
        <div className="container">
          <div className={`op-overview-content fade-section ${overviewVisible ? 'visible' : ''}`}>
            <h2 className="op-overview-title">Accurate Dispensing for Liquid Formulations</h2>
            <p className="op-overview-subtitle">
              Ashirwad Plastics offers precision-engineered measuring caps and oral droppers designed for accurate dosage measurement and convenient liquid administration. Built with pharmaceutical-grade materials, our solutions ensure reliable, leak-resistant performance for a wide range of liquid medicines and healthcare products.
            </p>
            ...
            <div className="op-showcase-card">
              ...
              <div className="op-carousel-wrapper">
                <div className="op-carousel-slide">
                  <img 
                    ...
                    alt={`Measuring Cap Render ${activeSlide + 1}`}
              ...
              <div style={{ padding: '24px 0', textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <p style={{ margin: 0, fontSize: '15px', color: '#475569', lineHeight: '1.6' }}>
                  <strong>Measuring Caps:</strong> Graduated measuring caps designed for precise dosage delivery of syrups and liquid medicines. Easy to read, easy to use, and built for pharmaceutical-grade accuracy.
                </p>
                <p style={{ margin: 0, fontSize: '15px', color: '#475569', lineHeight: '1.6' }}>
                  <strong>Oral Droppers:</strong> Precision-engineered oral droppers for controlled liquid dispensing. Suitable for pediatric medicines, herbal liquids, and a wide range of oral healthcare formulations.
                </p>
              </div>
              ...
              <div className="op-tags-wrapper" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '20px', borderTop: '1px solid var(--border-gray)', paddingTop: '40px', alignItems: 'flex-start' }}>
                <div className="op-tag-group" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '16px', flexWrap: 'wrap', textAlign: 'left', width: '100%' }}>
                  <span className="op-tag-label" style={{ fontSize: '15px', fontWeight: '700', color: '#1F2937', minWidth: '160px', flexShrink: 0 }}>Graduations</span>
                  <div className="op-tag-pills" style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                    <span className="op-pill">2.5 ml</span>
                    <span className="op-pill">5 ml</span>
                    <span className="op-pill">10 ml</span>
                    <span className="op-pill">Clear Embossed Markings</span>
                  </div>
                </div>
                ...
                <div className="op-tag-group" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '16px', flexWrap: 'wrap', textAlign: 'left', width: '100%' }}>
                  ...
                  <div className="op-tag-pills" style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                    <span className="op-pill">Pharmaceutical Grade Polypropylene</span>
                    <span className="op-pill">Food-Grade Plastic</span>
                  </div>
                </div>
              </div>
          ...
          <div className={`fade-section ${featureVisible ? 'visible' : ''}`}>
            ...
            <div className="op-features-grid">
              ...
              <div className="op-feature-card op-card-light">
                ...
                <div className="op-feature-list">
                  {[
                    "Precise liquid measurement and dosage control",
                    "User-friendly and easy-to-read design",
                    "Leak-resistant construction",
                    "Durable pharmaceutical-grade materials",
                    "Suitable for multiple liquid formulations",
            ...
            <div className="op-manufacturing-standards">
              ...
              <div className="op-mfg-desc">
                Produced in advanced manufacturing facilities with strict quality control systems to ensure dimensional accuracy, hygienic safety, and consistent performance across all liquid dispensing applications.
              </div>
            </div>
          ...
          <div className={`fade-section ${specsVisible ? 'visible' : ''}`}>
            ...
            <div className="op-table-wrapper">
              <table className="op-specs-table">
                ...
                <tbody>
                  {[
                    { spec: "Product Type", detail: "Measuring Caps & Oral Droppers" },
                    { spec: "Material", detail: "Pharmaceutical Grade Plastic" },
                    { spec: "Design", detail: "Graduated / Precision Dropper" },
                    { spec: "Application", detail: "Oral Liquid Formulations" },
            ...
            <div className="op-why-grid">
              ...
              <div className="op-why-left">
                ...
                <div className="op-why-list">
                  {[
                    "Precision-engineered for accurate dosage delivery",
                    "Pharmaceutical-grade materials for safe oral use",
                    "Reliable, leak-resistant construction",
                    "Suitable for a wide range of formulations",
                    "Consistent quality and high-volume availability"
                  ].map((why, idx) => (
      ...
      <section className="cta-banner-section" ref={ctaRef}>
        ...
        <div className="container">
          <div className="cta-banner-grid">
            <h2 className="cta-banner-heading">Looking for Accurate Oral Dispensing Solutions?</h2>
            <div className="cta-banner-right">
              <p className="cta-banner-desc">
                Connect with our team for customized measuring cap and oral dropper solutions for your product range.
              </p>
